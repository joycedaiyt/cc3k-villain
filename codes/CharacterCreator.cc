...
shared_ptr<Character> CharacterCreator::create_character_by_name(string character_name, int x_cord, int y_cord) {
    if (character_name == "human") {
        ...
        return make_shared<Dragon>(x_cord, y_cord);
    } else if (character_name == "halfling") {
        return make_shared<Halfling>(x_cord, y_cord);
    } else if (character_name == "drow") {
        return make_shared<Drow>(x_cord, y_cord);
    } else if (character_name == "shade") {
        return make_shared<Shade>(x_cord, y_cord);
    } else if (character_name == "vampire") {
        return make_shared<Vampire>(x_cord, y_cord);
    } else if (character_name == "goblin") {
        return make_shared<Goblin>(x_cord, y_cord);
    }
}